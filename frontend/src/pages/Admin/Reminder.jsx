...
import { Mail, Clock, Loader2, Menu } from "lucide-react";
...
const LoanRemindersPage = () => {
  ...
  const [menuOpen, setMenuOpen] = useState(false); // unified menu state
    ...
    <div className="flex min-h-screen bg-gray-50 relative">
      ...
      <div className="flex-1 p-6 md:ml-64 transition-all">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold flex items-center gap-2 text-gray-700">
            <Clock className="text-blue-600" size={24} /> Loan Reminders
          </h1>
        </div>
                ...
                {loans.map((loan) => {
                  ...
                  return (
                    <tr key={loan.loan_id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-2 px-3 text-red-500 font-semibold">{diffDays} days left</td>
